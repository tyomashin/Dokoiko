...
internal enum Asset {
  ...
  internal static let backgroundColorClearPrimary = ColorAsset(name: "backgroundColorClearPrimary")
  internal static let backgroundColorClearWhite = ColorAsset(name: "backgroundColorClearWhite")
  ...
  internal static let directionsCarFilledBlack = ImageAsset(name: "directions_car_filled_black")
  internal static let leisureDefaultImage = ImageAsset(name: "leisure-default-image")
  internal static let lifestyleDefaultImage = ImageAsset(name: "lifestyle-default-image")
  internal static let loadingCompletion = ImageAsset(name: "loading-completion")
  internal static let mapIcon = ImageAsset(name: "map-icon")
  internal static let mediumCircle = ImageAsset(name: "medium-circle")
  internal static let outlineCloseBlack = ImageAsset(name: "outline_close_black")
  internal static let recommendSearchIcon = ImageAsset(name: "recommend-search-icon")
  internal static let restaurantDefaultImage = ImageAsset(name: "restaurant-default-image")
  internal static let shoppingDefaultImage = ImageAsset(name: "shopping-default-image")
